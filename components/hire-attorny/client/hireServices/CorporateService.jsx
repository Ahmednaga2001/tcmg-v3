...
const CorporateService = () => {
  ...
  return (
    <section className={styles.attorneyrepresentation}>
      ...
      <p>
        عندما يتعلق الأمر بالخدمات القانونية للشركات، تقدم المجموعة التجارية
        والبحرية للمحاماة مجموعة شاملة من الحلول المصممة خصيصًا لتلبية احتياجات
        الشركات. قم بتوكيل محامي من فريقنا ذوي الخبرة الواسعة والمعرفة العميق,
        وأحصل على دعم شامل لشركتك في كافة الجوانب القانونية؛ مما يضمان نجاحها
        واستمراريتها في بيئة الأعمال التنافسية هذه.
      </p>
