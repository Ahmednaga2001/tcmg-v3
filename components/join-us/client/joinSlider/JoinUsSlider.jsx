...
const info = [
    {
      ...
      desc : "في TCMG، نتطلع بحماس لفكرة تعزيز شبكتنا العالمية من خلال إقامة شراكات استراتيجية مع مكاتب وشركات محاماة دولية. هذا التعاون سيسمح لنا بتوسيع نطاق خدماتنا وتعميق تأثيرنا في المشهد القانوني العالمي. من خلال تبادل الخبرات والموارد؛ نهدف إلى تقديم حلول قانونية أكثر شمولية ومبتكرة؛ مما يمكننا من مواجهة التحديات القانونية المعقدة بفعالية أكبر. نتطلع لبناء علاقات تعاونية تعود بالنفع على كل الأطراف المشاركة وتسهم في نمو وتطور قطاعنا.",
    ...
    },
    {
      ...
      desc : "في TCMG، نتطلع دائمًا إلى توسيع فريقنا بانضمام محامين جدد متميزين يشاركوننا رؤيتنا وشغفنا بالتميز القانوني. نؤمن بأن الأفكار المبتكرة والجديدة يمكن أن تعزز قدراتنا وتوسع نطاق خدماتنا. انضمام محامين جدد إلى فريقنا يُعد فرصة لهم لتطوير مهاراتهم في بيئة داعمة وتحفيزية, ولنا للاستفادة من مهاراتهم الفريدة في تحقيق أهدافنا المشتركة وتقديم أفضل الحلول القانونية لعملائنا.",
      path : "/assets/images/joinus/bottomL.png"
    },
    {
      id : 3,
      title : "عمل برنامج تدريب محامين جدد لتقوية فريقنا القانوني",
      desc : "في TCMG، نتطلع إلى إطلاق برنامج تدريب متكامل لمحامين جدد، بهدف تعزيز قدرات فريقنا القانوني وضمان استمرارية التميز في خدماتنا. نهدف من خلال هذا البرنامج إلى تزويد المحامين الطموحين بالمعرفة العميقة والمهارات العملية اللازمة لمواجهة التحديات القانونية المعاصرة بكفاءة. نؤمن بأن تطوير الجيل القادم من المحامين سيساهم ليس فقط في نموهم المهني، بل وفي تعزيز قدراتنا الجماعية كفريق واحد يسعى للريادة في المجال القانوني.",
