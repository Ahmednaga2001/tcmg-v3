...
const data = [
  {
    ...
    desc : "نوفر باقة الخدمات القانونية في عمليات الاندماج والاستحواذ؛ لضمان إدارة هذه العمليات بسلاسة وفعالية. نحن نساعد في التقييم القانوني للصفقات، إعداد الوثائق اللازمة وأيضًا ضمان حماية مصالح شركتك أثناء المفاوضات والتنفيذ. هدفنا هو تحقيق أهدافك التجارية بكفاءة مع تقليل المخاطر القانونية في كل ما يخص أعمال الشركات.",
  },
  {
    id: 2,
    ...
    alt : "التحكيم التجاري",
    desc : "نقدم خدمات قانونية في التحكيم التجاري لحل النزاعات التجارية بكفاءة عالية. حيث أننا نعمل في TCMG على تسوية القضايا بسرعة دون اللجوء إلى المحاكم؛ مما يوفر لك الوقت والتكاليف. تدعمك TCMG بمحامي تحكيم دولي يضمن لك الحفاظ على حقوقك، مع التركيز على تحقيق نتائج عادلة تلبي مصالح جميع الأطراف."
  },
  {
    id: 3,
    title: "تأسيس الشركات",
    ...
    desc : "نهتم بتوفير الدعم القانوني لرواد الأعمال بالمساعدة في تأسيس الشركات. بدءًا من إعداد العقود واللوائح الداخلية إلى تقديم خدمات مكتب المحاماة لضمان الامتثال للقوانين المحلية والدولية. نساعدك في جميع مراحل إنشاء شركتك؛ لتوفير أساس قوي وبنية قانونية متينة لضمان نجاح عملك الجديد."
  },
  {
    id: 4,
    title: "التقاضي",
    ...
    desc : "نقدم خدمات قانونية متكاملة للتقاضي، حيث نُمثل عملائنا في جميع مراحل القضايا القانونية. نعمل على تطوير استراتيجيات فعالة لضمان تحقيق نتائج إيجابية في المحاكم، بدءًا من تقديم الدعوى وحتى تنفيذ الأحكام. نحن ملتزمون بتقديم دعم قانوني متخصص لضمان حماية مصالحك وتحقيق العدالة بكفاءة عالية."
  },
];
