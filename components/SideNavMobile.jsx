                ...
                >
                  ...
                  >
                    {el.l4.options.map((option, idx) => (
                      <Link onClick={toggleSideNav} key={idx} href={el.l4.ref}>
                        {option}
                      </Link>
                    ))}
                  </div>
                  ...
                  <div
                    onClick={() => setShowSector((prev) => !prev)}
                    className={styles.prLink}
                  >
                  ...
                  >
                    {el.l5.options.map((option, idx) => (
                      <Link onClick={toggleSideNav} key={idx} href={el.l5.ref}>
                        {option}
                      </Link>
                    ))}
                  </div>
              ...
              data.map((el, index) => (
                ...
                >
                  <div
                    ...
                    className={styles.prLink}
                  >
                    <Link onClick={toggleSideNav} href={contact[0].l1.ref}>
                      {contact[0].l1.title}
                    </Link>
                    <Image
                      src={
          ...
          {isOpen && (
            ...
            >
              ...
              <div className={styles.reg}>
                ...
                <Link onClick={toggleSideNav} href="legal-advice#reserve"  className={styles.registerLink}>
                  احجز استشارتك الآن
                  <Image
